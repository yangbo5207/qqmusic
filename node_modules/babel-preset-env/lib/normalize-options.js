...
var validIncludesAndExcludes = [].concat(_toConsumableArray(Object.keys(_pluginFeatures2.default)), _toConsumableArray(Object.keys(_moduleTransformations2.default).map(function (m) {
  return _moduleTransformations2.default[m];
})), _toConsumableArray(Object.keys(_builtIns2.default)), _toConsumableArray(_defaultIncludes.defaultWebIncludes));
